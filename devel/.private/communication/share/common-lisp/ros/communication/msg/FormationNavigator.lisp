...
(cl:defmethod cl:initialize-instance :after ((m <FormationNavigator>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FormationNavigator)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name communication-msg:<FormationNavigator> is deprecated: use communication-msg:FormationNavigator instead.")))

(cl:ensure-generic-function 'count_number-val :lambda-list '(m))
(cl:defmethod count_number-val ((m <FormationNavigator>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader communication-msg:count_number-val is deprecated.  Use communication-msg:count_number instead.")
  (count_number m))
...
(cl:defmethod gap_x-val ((m <FormationNavigator>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader communication-msg:gap_x-val is deprecated.  Use communication-msg:gap_x instead.")
  (gap_x m))

(cl:ensure-generic-function 'gap_y-val :lambda-list '(m))
(cl:defmethod gap_y-val ((m <FormationNavigator>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader communication-msg:gap_y-val is deprecated.  Use communication-msg:gap_y instead.")
  (gap_y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FormationNavigator>)))
  ...
  "communication/FormationNavigator")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FormationNavigator)))
  "Returns string type for a message object of type 'FormationNavigator"
  "communication/FormationNavigator")
