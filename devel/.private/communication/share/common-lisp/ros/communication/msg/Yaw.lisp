...
(cl:defmethod cl:initialize-instance :after ((m <Yaw>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Yaw)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name communication-msg:<Yaw> is deprecated: use communication-msg:Yaw instead.")))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <Yaw>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader communication-msg:yaw-val is deprecated.  Use communication-msg:yaw instead.")
  (yaw m))
