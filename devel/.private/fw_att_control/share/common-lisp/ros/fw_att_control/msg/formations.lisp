...
(cl:defmethod cl:initialize-instance :after ((m <formations>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'formations)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fw_att_control-msg:<formations> is deprecated: use fw_att_control-msg:formations instead.")))

(cl:ensure-generic-function 'formationShape-val :lambda-list '(m))
(cl:defmethod formationShape-val ((m <formations>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fw_att_control-msg:formationShape-val is deprecated.  Use fw_att_control-msg:formationShape instead.")
  (formationShape m))
