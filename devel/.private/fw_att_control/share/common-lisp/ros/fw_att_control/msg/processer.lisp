...
(cl:defmethod cl:initialize-instance :after ((m <processer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'processer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fw_att_control-msg:<processer> is deprecated: use fw_att_control-msg:processer instead.")))

(cl:ensure-generic-function 'execflag-val :lambda-list '(m))
(cl:defmethod execflag-val ((m <processer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fw_att_control-msg:execflag-val is deprecated.  Use fw_att_control-msg:execflag instead.")
  (execflag m))
