...
class uavflag {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.controlmode, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.controlmode = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'fw_msgs/uavflag';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'c1082356661093bc9487862125a2ea71';
  }
