...
(cl:defmethod cl:initialize-instance :after ((m <ACK>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ACK)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fw_msgs-msg:<ACK> is deprecated: use fw_msgs-msg:ACK instead.")))
...
(cl:defmethod judge-val ((m <ACK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fw_msgs-msg:judge-val is deprecated.  Use fw_msgs-msg:judge instead.")
  (judge m))
