...
(cl:defmethod cl:initialize-instance :after ((m <QgcCommands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QgcCommands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fw_msgs-msg:<QgcCommands> is deprecated: use fw_msgs-msg:QgcCommands instead.")))
...
(cl:defmethod gsid-val ((m <QgcCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fw_msgs-msg:gsid-val is deprecated.  Use fw_msgs-msg:gsid instead.")
  (gsid m))
...
(cl:defmethod uavnumber-val ((m <QgcCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fw_msgs-msg:uavnumber-val is deprecated.  Use fw_msgs-msg:uavnumber instead.")
  (uavnumber m))

(cl:ensure-generic-function 'tasktype-val :lambda-list '(m))
(cl:defmethod tasktype-val ((m <QgcCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fw_msgs-msg:tasktype-val is deprecated.  Use fw_msgs-msg:tasktype instead.")
  (tasktype m))
