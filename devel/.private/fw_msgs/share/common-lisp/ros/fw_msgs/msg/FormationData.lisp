...
(cl:defmethod cl:initialize-instance :after ((m <FormationData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FormationData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fw_msgs-msg:<FormationData> is deprecated: use fw_msgs-msg:FormationData instead.")))

(cl:ensure-generic-function 'count_number-val :lambda-list '(m))
(cl:defmethod count_number-val ((m <FormationData>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FormationData>)))
  ...
  "2928bb8a289249d6e0ebeda4942d0551")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FormationData)))
  "Returns md5sum for a message object of type 'FormationData"
  "2928bb8a289249d6e0ebeda4942d0551")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FormationData>)))
  ...
  (cl:format cl:nil "# FormationData.msg~%~%float64 count_number~%float64 position_x~%float64 position_y~%float64 position_z~%~%float64 homeLat~%float64 homeLon~%float64 homeAlt~%time gps_time~%~%float64 leaderHeading~%float64 leaderCommand_yaw~%float64 leaderAirspeed~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FormationData)))
  "Returns full string definition for message of type 'FormationData"
  (cl:format cl:nil "# FormationData.msg~%~%float64 count_number~%float64 position_x~%float64 position_y~%float64 position_z~%~%float64 homeLat~%float64 homeLon~%float64 homeAlt~%time gps_time~%~%float64 leaderHeading~%float64 leaderCommand_yaw~%float64 leaderAirspeed~%~%"))
