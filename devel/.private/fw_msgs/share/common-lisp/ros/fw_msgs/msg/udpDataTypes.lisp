...
(cl:defmethod cl:initialize-instance :after ((m <udpDataTypes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'udpDataTypes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fw_msgs-msg:<udpDataTypes> is deprecated: use fw_msgs-msg:udpDataTypes instead.")))

(cl:ensure-generic-function 'startUDP_Data-val :lambda-list '(m))
(cl:defmethod startUDP_Data-val ((m <udpDataTypes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fw_msgs-msg:startUDP_Data-val is deprecated.  Use fw_msgs-msg:startUDP_Data instead.")
  (startUDP_Data m))

(cl:ensure-generic-function 'startUPD_HOME-val :lambda-list '(m))
(cl:defmethod startUPD_HOME-val ((m <udpDataTypes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fw_msgs-msg:startUPD_HOME-val is deprecated.  Use fw_msgs-msg:startUPD_HOME instead.")
  (startUPD_HOME m))

(cl:ensure-generic-function 'startACK-val :lambda-list '(m))
(cl:defmethod startACK-val ((m <udpDataTypes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fw_msgs-msg:startACK-val is deprecated.  Use fw_msgs-msg:startACK instead.")
  (startACK m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<udpDataTypes>)))
  ...
  (cl:format cl:nil "# udpDataTypes.msg~%~%~%int8 startUDP_Data~%int8 startUPD_HOME~%int8 startACK~%~%# 数据分发~%# 数据控制~%~%# taskType_sub = nh.advertise<fw_msgs::udpDataTypes>~%#           (\"communication/taskTypes/udpDataTypes\", 1);~%~%# taskType_sub = nh.subscribe<fw_msgs::QgcCommands>~%#           (uavName + \"/communication/QgcCommands\" + s_i,1, handler_taskType);~%# ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'udpDataTypes)))
  "Returns full string definition for message of type 'udpDataTypes"
  (cl:format cl:nil "# udpDataTypes.msg~%~%~%int8 startUDP_Data~%int8 startUPD_HOME~%int8 startACK~%~%# 数据分发~%# 数据控制~%~%# taskType_sub = nh.advertise<fw_msgs::udpDataTypes>~%#           (\"communication/taskTypes/udpDataTypes\", 1);~%~%# taskType_sub = nh.subscribe<fw_msgs::QgcCommands>~%#           (uavName + \"/communication/QgcCommands\" + s_i,1, handler_taskType);~%# ~%~%~%"))
