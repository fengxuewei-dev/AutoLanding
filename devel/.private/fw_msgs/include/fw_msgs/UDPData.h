// Generated by gencpp from file fw_msgs/UDPData.msg
// DO NOT EDIT!


#ifndef FW_MSGS_MESSAGE_UDPDATA_H
#define FW_MSGS_MESSAGE_UDPDATA_H
...
struct UDPData_
{
  ...
  typedef boost::shared_ptr< ::fw_msgs::UDPData_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::fw_msgs::UDPData_<ContainerAllocator> const> ConstPtr;

}; // struct UDPData_

typedef ::fw_msgs::UDPData_<std::allocator<void> > UDPData;

typedef boost::shared_ptr< ::fw_msgs::UDPData > UDPDataPtr;
typedef boost::shared_ptr< ::fw_msgs::UDPData const> UDPDataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::fw_msgs::UDPData_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::fw_msgs::UDPData_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::fw_msgs::UDPData_<ContainerAllocator1> & lhs, const ::fw_msgs::UDPData_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::fw_msgs::UDPData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::fw_msgs::UDPData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::fw_msgs::UDPData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::fw_msgs::UDPData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::fw_msgs::UDPData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::fw_msgs::UDPData_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::fw_msgs::UDPData_<ContainerAllocator> >
{
  ...
  static const char* value(const ::fw_msgs::UDPData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1ff2b4674f767520ULL;
  static const uint64_t static_value2 = 0x061c38046240545fULL;
};

template<class ContainerAllocator>
struct DataType< ::fw_msgs::UDPData_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::fw_msgs::UDPData_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::fw_msgs::UDPData_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::fw_msgs::UDPData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::fw_msgs::UDPData_<ContainerAllocator>& v)
  {
    s << indent << "number: ";
...
#endif // FW_MSGS_MESSAGE_UDPDATA_H
