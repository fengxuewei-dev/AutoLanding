...
TEST(common, SELF_FAX_FORMATION)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::SELF_FAX_FORMATION packet_in{};
    packet_in.ned_vel_x = 123.0;
    packet_in.ned_vel_y = 179.0;
    packet_in.ned_vel_z = 235.0;
    packet_in.latitude = 291.0;
    packet_in.altitude = 347.0;
    packet_in.longtitude = 403.0;

    mavlink::common::msg::SELF_FAX_FORMATION packet1{};
    mavlink::common::msg::SELF_FAX_FORMATION packet2{};
    ...
    EXPECT_EQ(packet1.ned_vel_x, packet2.ned_vel_x);
    EXPECT_EQ(packet1.ned_vel_y, packet2.ned_vel_y);
    EXPECT_EQ(packet1.ned_vel_z, packet2.ned_vel_z);
    EXPECT_EQ(packet1.latitude, packet2.latitude);
    EXPECT_EQ(packet1.altitude, packet2.altitude);
    EXPECT_EQ(packet1.longtitude, packet2.longtitude);
}

#ifdef TEST_INTEROP
TEST(common_interop, SELF_FAX_FORMATION)
{
    mavlink_message_t msg;
    ...
    mavlink_self_fax_formation_t packet_c {
    ...
    mavlink_msg_self_fax_formation_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.ned_vel_x, packet2.ned_vel_x);
    EXPECT_EQ(packet_in.ned_vel_y, packet2.ned_vel_y);
    EXPECT_EQ(packet_in.ned_vel_z, packet2.ned_vel_z);
    EXPECT_EQ(packet_in.latitude, packet2.latitude);
    EXPECT_EQ(packet_in.altitude, packet2.altitude);
    EXPECT_EQ(packet_in.longtitude, packet2.longtitude);
...
TEST(common, SELF_FAX_FORMATION_RC)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::SELF_FAX_FORMATION_RC packet_in{};
    packet_in.message_id = 19939;
    packet_in.uav_id = 20043;
    packet_in.plane_state = 20147;
    packet_in.plane_group = 20251;
    packet_in.number = 963499960;
    packet_in.longitude_x = 123.0;
    packet_in.latitude_y = 179.0;
    packet_in.altitude_z = 235.0;
    packet_in.heading = 291.0;
    packet_in.velocity = 347.0;
    packet_in.command_yaw = 403.0;

    mavlink::common::msg::SELF_FAX_FORMATION_RC packet1{};
    mavlink::common::msg::SELF_FAX_FORMATION_RC packet2{};
    ...
    EXPECT_EQ(packet1.plane_state, packet2.plane_state);
    EXPECT_EQ(packet1.plane_group, packet2.plane_group);
    EXPECT_EQ(packet1.number, packet2.number);
    EXPECT_EQ(packet1.longitude_x, packet2.longitude_x);
    EXPECT_EQ(packet1.latitude_y, packet2.latitude_y);
    EXPECT_EQ(packet1.altitude_z, packet2.altitude_z);
    EXPECT_EQ(packet1.heading, packet2.heading);
    EXPECT_EQ(packet1.velocity, packet2.velocity);
    EXPECT_EQ(packet1.command_yaw, packet2.command_yaw);
}

#ifdef TEST_INTEROP
TEST(common_interop, SELF_FAX_FORMATION_RC)
{
    mavlink_message_t msg;
    ...
    mavlink_self_fax_formation_rc_t packet_c {
    ...
    mavlink_msg_self_fax_formation_rc_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.plane_state, packet2.plane_state);
    EXPECT_EQ(packet_in.plane_group, packet2.plane_group);
    EXPECT_EQ(packet_in.number, packet2.number);
    EXPECT_EQ(packet_in.longitude_x, packet2.longitude_x);
    EXPECT_EQ(packet_in.latitude_y, packet2.latitude_y);
    EXPECT_EQ(packet_in.altitude_z, packet2.altitude_z);
    EXPECT_EQ(packet_in.heading, packet2.heading);
    EXPECT_EQ(packet_in.velocity, packet2.velocity);
    EXPECT_EQ(packet_in.command_yaw, packet2.command_yaw);
...
TEST(common, QGCOMMANDS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::QGCOMMANDS packet_in{};
    packet_in.message_id = 19107;
    packet_in.uav_id = 19211;
    packet_in.gs_id = 19315;
    packet_in.vehicleNumber = 19419;
    packet_in.taskType = 963499128;
    packet_in.plane_state = 123.0;
    packet_in.plane_group = 179.0;
    packet_in.gapx = 235.0;
    packet_in.gapy = 291.0;

    mavlink::common::msg::QGCOMMANDS packet1{};
    mavlink::common::msg::QGCOMMANDS packet2{};
    ...
    EXPECT_EQ(packet1.message_id, packet2.message_id);
    EXPECT_EQ(packet1.uav_id, packet2.uav_id);
    EXPECT_EQ(packet1.gs_id, packet2.gs_id);
    EXPECT_EQ(packet1.vehicleNumber, packet2.vehicleNumber);
    EXPECT_EQ(packet1.taskType, packet2.taskType);
    EXPECT_EQ(packet1.plane_state, packet2.plane_state);
    EXPECT_EQ(packet1.plane_group, packet2.plane_group);
    EXPECT_EQ(packet1.gapx, packet2.gapx);
    EXPECT_EQ(packet1.gapy, packet2.gapy);
}

#ifdef TEST_INTEROP
TEST(common_interop, QGCOMMANDS)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_qgcommands_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.message_id, packet2.message_id);
    EXPECT_EQ(packet_in.uav_id, packet2.uav_id);
    EXPECT_EQ(packet_in.gs_id, packet2.gs_id);
    EXPECT_EQ(packet_in.vehicleNumber, packet2.vehicleNumber);
    EXPECT_EQ(packet_in.taskType, packet2.taskType);
    EXPECT_EQ(packet_in.plane_state, packet2.plane_state);
    EXPECT_EQ(packet_in.plane_group, packet2.plane_group);
    EXPECT_EQ(packet_in.gapx, packet2.gapx);
    EXPECT_EQ(packet_in.gapy, packet2.gapy);
