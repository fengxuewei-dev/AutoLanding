...
static void mavlink_test_self_fax_formation_rc(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SELF_FAX_FORMATION_RC >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_self_fax_formation_rc_t packet_in = {
        123.0,179.0,235.0,291.0,347.0,403.0,963499960,19939,20043,20147,20251
    };
    mavlink_self_fax_formation_rc_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.longitude_x = packet_in.longitude_x;
        packet1.latitude_y = packet_in.latitude_y;
        packet1.altitude_z = packet_in.altitude_z;
        packet1.heading = packet_in.heading;
        packet1.velocity = packet_in.velocity;
        packet1.command_yaw = packet_in.command_yaw;
        packet1.number = packet_in.number;
        packet1.message_id = packet_in.message_id;
        packet1.uav_id = packet_in.uav_id;
        packet1.plane_state = packet_in.plane_state;
        packet1.plane_group = packet_in.plane_group;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SELF_FAX_FORMATION_RC_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SELF_FAX_FORMATION_RC_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_self_fax_formation_rc_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_self_fax_formation_rc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_self_fax_formation_rc_pack(system_id, component_id, &msg , packet1.message_id , packet1.uav_id , packet1.plane_state , packet1.plane_group , packet1.number , packet1.longitude_x , packet1.latitude_y , packet1.altitude_z , packet1.heading , packet1.velocity , packet1.command_yaw );
    mavlink_msg_self_fax_formation_rc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_self_fax_formation_rc_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.message_id , packet1.uav_id , packet1.plane_state , packet1.plane_group , packet1.number , packet1.longitude_x , packet1.latitude_y , packet1.altitude_z , packet1.heading , packet1.velocity , packet1.command_yaw );
    mavlink_msg_self_fax_formation_rc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_self_fax_formation_rc_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_self_fax_formation_rc_send(MAVLINK_COMM_1 , packet1.message_id , packet1.uav_id , packet1.plane_state , packet1.plane_group , packet1.number , packet1.longitude_x , packet1.latitude_y , packet1.altitude_z , packet1.heading , packet1.velocity , packet1.command_yaw );
    mavlink_msg_self_fax_formation_rc_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_qgcommands(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_QGCOMMANDS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_qgcommands_t packet_in = {
        123.0,179.0,235.0,291.0,963499128,19107,19211,19315,19419
    };
    mavlink_qgcommands_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.plane_state = packet_in.plane_state;
        packet1.plane_group = packet_in.plane_group;
        packet1.gapx = packet_in.gapx;
        packet1.gapy = packet_in.gapy;
        packet1.taskType = packet_in.taskType;
        packet1.message_id = packet_in.message_id;
        packet1.uav_id = packet_in.uav_id;
        packet1.gs_id = packet_in.gs_id;
        packet1.vehicleNumber = packet_in.vehicleNumber;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_QGCOMMANDS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_QGCOMMANDS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgcommands_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_qgcommands_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgcommands_pack(system_id, component_id, &msg , packet1.message_id , packet1.uav_id , packet1.gs_id , packet1.vehicleNumber , packet1.taskType , packet1.plane_state , packet1.plane_group , packet1.gapx , packet1.gapy );
    mavlink_msg_qgcommands_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgcommands_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.message_id , packet1.uav_id , packet1.gs_id , packet1.vehicleNumber , packet1.taskType , packet1.plane_state , packet1.plane_group , packet1.gapx , packet1.gapy );
    mavlink_msg_qgcommands_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_qgcommands_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgcommands_send(MAVLINK_COMM_1 , packet1.message_id , packet1.uav_id , packet1.gs_id , packet1.vehicleNumber , packet1.taskType , packet1.plane_state , packet1.plane_group , packet1.gapx , packet1.gapy );
    mavlink_msg_qgcommands_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_self_fax_formation_rc(system_id, component_id, last_msg);
    mavlink_test_qgcommands(system_id, component_id, last_msg);
