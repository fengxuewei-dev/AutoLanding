...
# --tab -e 'bash -c "rosrun communication UDP_Send_QGCommand uav3 -mt QC -p 9000 9001 9002 9003 9004 -QCp 2 40 1 2 1 -10 10"' \
# --tab -e 'bash -c "rosrun communication UDP_Send_QGCommand uav4 -mt QC -p 9000 9001 9002 9003 9004 -QCp 2 40 1 2 1 -10 -10"' 
