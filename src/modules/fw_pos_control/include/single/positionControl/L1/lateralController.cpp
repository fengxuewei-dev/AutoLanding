#include "lateralController.hpp"
    ...
    float LATERAL_CONTROLLER::get_lateral_roll_sp()
    {
        return roll_sp;
    }

    float LATERAL_CONTROLLER::get_lateral_acc_lateral()
    {
        return acc_lateral;
    }

    void LATERAL_CONTROLLER::set_l1_period(float period)
    {
        _L1_period = period;
    ...
    void LATERAL_CONTROLLER::set_l1_damping(float damping)
    {
        _L1_damping = damping;
        /* calculate the ratio introduced in [2] */
        _L1_ratio = 1.0f / PI * _L1_damping * _L1_period;
    ...
    void LATERAL_CONTROLLER::set_l1_roll_limit(float roll_lim_rad)
    {
        _roll_lim_rad = roll_lim_rad;
    }

    float LATERAL_CONTROLLER::nav_roll()
    {
    ...
    float LATERAL_CONTROLLER::nav_lateral_acceleration_demand()
    {
        return _lateral_accel;
    }

    float LATERAL_CONTROLLER::nav_bearing()
    {
        return _nav_bearing;
    }
